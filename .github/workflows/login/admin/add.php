<?php 
  ...
  if ($_SERVER['REQUEST_METHOD']=='POST'){
    ...
    if(!isset($name) || $name == '' || !isset($mobile) || $mobile == '' || !isset($email) || $email == '' || !isset($address) || $address == ''){
      ...
      $sql = "INSERT INTO `students_info` (`name`, `mobile`, `email`, `address`) VALUES ('$name', '$mobile', '$email', '$address'); ";
              ...
              <div class="row">
                <div class="col-md-9">
                  ...
                  <form action="add.php" method="POST">
                    ...
                    <h4 class="sinfo">Add Infomation</h4>
                    ...
                    <button class="w-100 btn btn-lg btn-primary" type="submit">Add Record</button>
                  </form>
